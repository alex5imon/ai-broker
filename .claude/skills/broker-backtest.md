---
description: Backtest strategies against historical data — S&P 500 daily, SPY intraday, or multi-ticker intraday
---

# Backtest Strategies Against Historical Data

Replay past market data through the strategy engine to see what trades would have been taken and how they would have performed. The project supports three backtest modes via `multi_strategy_backtest`.
