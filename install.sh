...
echo ""
echo "Next steps:"
echo "  1. Set required env vars in .env (see .env.example):"
echo "       ALPACA_PAPER_KEY_ID, ALPACA_PAPER_SECRET (or LIVE pair)"
echo "       FINNHUB_API_KEY, NTFY_TOPIC, NTFY_KILL_TOPIC"
echo "  2. Edit config.yaml if needed (watchlist, risk limits, etc.)"
