...
The ``EntryEvaluator`` tests that used to live here were removed in
ai-broker#125 together with the class itself; the live entry path runs
through ``StrategyManager`` and is exercised by ``test_strategy_manager*``.
"""
