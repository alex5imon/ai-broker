...
- Bot subscribes to a dedicated ntfy topic (e.g., `trading-bot-kill-U5433252`)
...
- **Topic**: User-configurable in `config.yaml` (e.g., `trading-bot-U5433252`)
- **Kill switch topic**: Separate topic for kill commands (e.g., `trading-bot-kill-U5433252`)
...
notifications:
  ...
  ntfy_topic: "trading-bot-U5433252"
  ntfy_kill_topic: "trading-bot-kill-U5433252"
  priorities:
